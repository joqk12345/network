...
//        new ExportDocTest().exportDoc(destFile, fileCon.toString());
        ...
        File f = new File(ExportDocTest.class.getResource("/").getPath());

        String templatePath = f.toString()+"\\biyezheng_moban.doc";
        System.out.println(templatePath);
        HWPFDocument document=new ExportDocTest().replaceDoc(templatePath, map);
